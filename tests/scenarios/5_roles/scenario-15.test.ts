describe.skip("Cenário 15 - Alteração de role específica por ID (PUT /roles/{id})", () => {
  ...
  test("15.3 - Retornar erro de formato para alteração de roles sem todos os parâmetros obrigatórios", () => {});

  test("15.4 - Retornar erro de requisição para alteração com permissões inexistentes", () => {});
});
