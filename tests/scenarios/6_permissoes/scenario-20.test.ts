describe.skip("Cenário 20 - Alterar permissão específica por meio de ID (PUT /permissoes/{id})", () => {
  ...
  test("20.3 - Retornar erro de formato para alteração de regra específica sem todos os parâmetros obrigatórios", () => {});

  test("20.4 - Retornar erro de rota para id não cadastrado", () => {});
});
