describe("Cenário 10 - Alteração de cadastro de usuário específico (PUT /usuarios/{id})", () => {
  ...
  test("10.3 - Retornar erro de formato para requisição sem todos os parâmetros obrigatórios", () => {});

  test("10.4 - Retornar erro de rota para id não cadastrado", () => {});

  test("10.5 - Retornar erro de requisição para role inexistente", () => {});
});
